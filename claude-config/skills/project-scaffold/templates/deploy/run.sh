#!/bin/bash
# deploy/run.sh — Deploy {project-name} from main branch
...
APP_DIR="/opt/{project-name}/{project-name}"
...
#
# Uses `sg` to activate the {project-name} group for the wrapped command.
